...
// };
//
// const setupTextHover = (container: HTMLElement | null, type: "subtitle" | "title"): (() => void) => {
//     if (!container) return () => {
//     };
//     const letters = container.querySelectorAll<HTMLSpanElement>('span');
//     const {min, max, default: base} = FONT_WEIGHTS[type];
//
//     const animateLetter = (letter: HTMLElement, weight: number, duration = 0.25): gsap.core.Tween =>
//         gsap.to(letter, {
//             duration,
//             ease: "power2.out",
//             fontVariationSettings: `'wght' ${weight}`,
...
//     return (
//         <section id="welcome">
//             <p ref={subtitleRef}>{renderText("Hey, i'm Alireza! Welcome to my", 'text-3xl font-georama', 100)}</p>
